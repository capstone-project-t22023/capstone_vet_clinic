...
export default function ReceiptPdf() {
  ...
  useEffect(() => {
    ...
    console.log("invoiceItemRows", invoiceItemRows);
  ...
  return (
    <>
      ...
      <PDFViewer style={styles.viewer}>
        <Document title={"receipt-" + header.receipt_id}>
              ...
              <View style={styles.headerDataTable}>
                <View style={styles.headerDataRow}>
                  <View style={styles.headerDataCol}>
                    <Text style={styles.headerDataCell}>Invoice ID: {header.invoice_id}</Text>
                  </View>
                  <View style={styles.headerDataCol}>
                    <Text style={styles.headerDataCell}>Payment Status: {header.payment_status}</Text>
                  </View>
                </View>
                <View style={styles.headerDataRow}>
                  <View style={styles.headerDataCol}>
                    <Text style={styles.headerDataCell}>Receipt ID: {header.receipt_id}</Text>
                  </View>
                  <View style={styles.headerDataCol}>
                    <Text style={styles.headerDataCell}>Payment Date: {header.payment_date}</Text>
                  </View>
                </View>
                <View style={styles.headerDataRow}>
                  <View style={styles.headerDataCol}>
                    <Text style={styles.headerDataCell}></Text>
                  </View>
                  <View style={styles.headerDataCol}>
                    <Text style={styles.headerDataCell}>Payment Received By: {header.admin_name}</Text>
                  </View>
                </View>
              </View>
              <Text style={styles.headerData}> </Text>
