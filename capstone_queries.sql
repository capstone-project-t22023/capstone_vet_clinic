...
CREATE TABLE `pawsome`.`payments` (
  ...
  `payment_change` decimal(5,2) NOT NULL COMMENT 'Change returned from payment made',
  `updated_by` int(10) DEFAULT NULL COMMENT 'Updated by user',
  `updated_date` datetime DEFAULT NULL COMMENT 'Updated date',
  PRIMARY KEY (`id`),
...
(2,'Parainfluenza virus (PI)',10,18,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),80,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Bordetella bronchiseptica (Bb)',10,16,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),120,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Leptospira interrogans',10,14,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),94,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Feline parvovirus (FPV)',10,13,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),87,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Feline calicivirus (FCV)',10,10,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),90,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Feline herpesvirus (FHV-1)',10,16,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),80,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Feline leukaemia virus (FeLV)',10,17,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),85,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Chlamydia felis',10,18,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),85,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Feline immunodeficiency virus (FIV)',10,18,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),85,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
(2,'Rabies',10,25,15,10,'millilitres',STR_TO_DATE("30-09-2022", "%d-%m-%Y"),STR_TO_DATE("30-09-2025", "%d-%m-%Y"),95,(SELECT id FROM `pawsome`.`admins` WHERE username = 'pawsome_admin'),SYSDATE(),0),
